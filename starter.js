...
const calculator =(num1, num2, callback) => {
    if(+num1 && +num2){
        ...
        console.log(`Math requires numbers.`)
    }
}
...
const  speciesDiscount = (arr, callback ,discount) => {
    arr.forEach((product) => {
...
const categoryDiscount = (category, callback, discount) => {
    arr.forEach(product => {
...
// categoryDiscount(catProducts, 1, percentDiscount, .10)
// console.log(catProducts)

// const inventDisc = (arr, inventory, callback, discount)
...
const remaining = expenses.reduce((acc, cv) => {return acc - cv.amount}, 2000)
